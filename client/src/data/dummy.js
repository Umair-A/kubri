...
const gridEmployeeDescription = (props) => (
...
const listsGridMakerSymbol = (props) => (
  <div className="image flex gap-4">
    {/* <img
      className="rounded-full w-10 h-10"
      src={props.CustomerImage}
...
const customerGridBase = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    {/* <p style={{ background: props.StatusBg }} className="rounded-full h-3 w-3" /> */}
    <p>{props.Base}</p>
  </div>
);
const customerGridQuote = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <p>{props.Quote}</p>
  </div>
);
const customerGridCategory = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <p>{props.Category}</p>
  </div>
);
...
export const listsGrid = [
  ...
  { headerText: 'UniversalSymbols',
    ...
    textAlign: 'Center' },
  { headerText: 'Maker Symbols',
    width: '150',
    template: listsGridMakerSymbol,
    textAlign: 'Center' },
  { field: 'Security',
    headerText: 'Security',
    width: '150',
  ...
  { field: 'Sessions',
    ...
    textAlign: 'Center' },
  { field: 'MarkupBid',
    headerText: 'MarkUp Bid',
    width: '150',
    textAlign: 'Center' },
  { field: 'MarkupAsk',
    headerText: 'MarkUp Ask',
    width: '150',
    textAlign: 'Center' },
  { field: 'Depth',
    headerText: 'Depth',
  ...
  { field: 'ExpiryDate',
    ...
    textAlign: 'Center' },
  { field: 'SubVolumes',
    headerText: 'Sub volumes',
    width: '150',
    textAlign: 'Center' },
  { field: 'TimeOutWarn',
    headerText: 'TimeOut Warn(ms)',
    width: '150',
    textAlign: 'Center' },
  { field: 'TimeOutError',
    headerText: 'TimeOut Error(ms)',
    width: '150',
    textAlign: 'Center' },
  { field: 'TimeOutKill',
    headerText: 'TimeOut Kill',
    width: '150',
    textAlign: 'Center' },
  { field: 'TimeOutBprice',
    headerText: 'TimeOut B price(ms)',
    width: '150',
    textAlign: 'Center' },
  { field: 'FeedSide',
    headerText: 'Feed Side',
    width: '150',
    textAlign: 'Center' },
  { field: 'IPFE',
    headerText: 'Ignore Prices for B exec',
    width: '150',
    textAlign: 'Center' },
  { field: 'Description',
    headerText: 'Description',
...
export const listsMarkupGrid = [
  ...
  { field: 'Sessions',
    ...
    textAlign: 'Center' },
  { field: 'MarkupBid',
    headerText: 'MarkUpBid',
    width: '150',
    textAlign: 'Center' },
  { field: 'MarkupAsk',
    headerText: 'MarkUpAsk',
    width: '150',
    textAlign: 'Center' },
  { field: 'MarkupBidVar',
    headerText: 'MarkupBidVar',
    width: '150',
    textAlign: 'Center' },
  { field: 'MarkupAskVar',
    headerText: 'MarkupAskVar',
    width: '150',
    textAlign: 'Center' },
  { field: 'SpreadMin',
    headerText: 'SpreadMin',
    width: '150',
    textAlign: 'Center' },
  { field: 'SpreadMax',
    headerText: 'SpreadMax',
    width: '150',
    textAlign: 'Center' },
  { field: 'SpreadExec',
    headerText: 'SpreadExec',
    width: '150',
    textAlign: 'Center' },
  { field: 'ExtraDigits',
    headerText: 'ExtraDigits',
    width: '150',
    textAlign: 'Center' },
  { field: 'Enable',
    headerText: 'Enable',
...
export const MakerApiLinkGrid = [
  { type: 'checkbox', width: '50' },
  { field: 'Takers',
    headerText: 'Takers',
    width: '150',
    textAlign: 'Center' },
  { field: 'TakerExecutionModel',
    headerText: 'Taker Execution Model',
    width: '150',
    textAlign: 'Center' },
  { field: 'HubAggregationModel',
    headerText: 'HubAggregationModel',
    width: '150',
    textAlign: 'Center' },
  { field: 'Securities',
...
export const listsDataFeedGrid = [
  { type: 'checkbox', width: '50' },
  { headerText: 'UniversalSymbols',
    width: '150',
    template: customerGridImage,
  ...
  { field: 'Taker',
    ...
    textAlign: 'Center' },
  { field: 'TakerFeed',
    headerText: 'Taker Feed',
    width: '150',
    textAlign: 'Center' },
  { field: 'TakerSymbol',
    headerText: 'Taker Symbol',
    width: '150',
    textAlign: 'Center' },
  { field: 'Base',
    headerText: 'Base',
  ...
  { field: 'Quote',
    ...
    textAlign: 'Center' },
  { field: 'HubAggregationModel',
    headerText: 'Hub Aggregation Model',
    width: '150',
    textAlign: 'Center' },
  { field: 'MarkupModel',
    headerText: 'Markup Model',
    width: '150',
    textAlign: 'Center' },
  { field: 'FeedMode',
    headerText: 'Feed Mode',
    width: '150',
    textAlign: 'Center' },
  { field: 'Levels',
    headerText: 'Levels',
  ...
  { field: 'Depth',
    ...
    textAlign: 'Center' },
  { field: 'FeedSource',
    headerText: 'Feed Source',
    width: '150',
    textAlign: 'Center' },
  { field: 'FeedTOBVolume',
    headerText: 'Feed TOB Volume',
    width: '150',
    textAlign: 'Center' },
  { field: 'FeedMulti',
    headerText: 'Feed Multi',
    width: '150',
    textAlign: 'Center' },
  { field: 'PriceMood',
    headerText: 'Price Mood',
    width: '150',
    textAlign: 'Center' },
  { field: 'Sessions',
    headerText: 'Sessions',
...
export const chatData = [
  ...
  },
  {
    ...
    desc: 'Kubri sent you new message',
    time: '11:56 AM',
  },
  {
    image:
...
export const TakerListsData = [
  {
    CustomerID: 1001,
    Taker: 'CentroidUILocal',
    Type: 'CENTROIDAPI',
    IpList: '',
    Enable: '',
    Description: 'Text',
...
export const MakerApiLinkData = [
  {
    CustomerID: 1001,
    Takers: 'CentroidUiLocal',
    TakersExecutionModel: '*,',
    HubAggregationModels: '*,',
    Securities: '*,',
    Symbols: '*,',
    SharedIDs: 'LMAX_DEMO',
    Sides: '*,',
...
export const listsTakerFeedData = [
  {
    CustomerID: 1001,
    CustomerName: 'AUDCAD',
    Security: 'CFD',
    ...
    Base: 'SPX',
    Quote: 'USD',
    HubAggregationModel: 'C24toC24',
    MarkupModel: 'Raw_markup',
    FeedMode: 'AGGREGATE',
    Levels: '',
    MinVolume: '0',
    Depth: '5',
